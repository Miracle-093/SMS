...
export enum PermissionKey {
  ...
  AcademicSetupManage = "academic-setup.manage",
  TeacherSubjectsManage = "teacher-subjects.manage",
  ClassTeachersManage = "class-teachers.manage",
  ...
  ReportCardsPrepare = "report-cards.prepare",
  ReportCardsPublish = "report-cards.publish",
