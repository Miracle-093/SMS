    ...
    <div className="kiosk">
      <section className="kiosk-panel">
        ...
        <div className="actions">
          <button type="button" onClick={() => submit("check-in")}>Check In</button>
          <button type="button" onClick={() => submit("check-out")}>Check Out</button>
        </div>
        {lastRecord && (
          <div className="kiosk-correction">
            ...
            <button className="ghost" type="button" onClick={() => void requestCorrection()}>Request Correction</button>
          </div>
        )}
        <p>{message}</p>
      </section>
